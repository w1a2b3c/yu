...
if(isset($_POST['user']) && isset($_POST['pass'])){
	...
	if (!$code || ($code != $_SESSION['vc_code'])) {
		...
		@header('Content-Type: text/html; charset=UTF-8');
		exit("<script language='javascript'>alert('登陆管理中心成功！');window.location.href='./classlist.php';</script>");
	}else {
		unset($_SESSION['vc_code']);
		@header('Content-Type: text/html; charset=UTF-8');
  ...
  <nav class="navbar navbar-fixed-top navbar-default">
    <div class="container">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="./">卡密系统后台</a>
      </div><!-- /.navbar-header -->
      ...
      <div class="panel panel-primary">
        ...
        <div class="panel-body">
          <form action="./login.php" method="post" class="form-horizontal" role="form">
			...
			<center><a href="http://www.njymz.com/">更多源码访问牛角源码资源网</a></center>
